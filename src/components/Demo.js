    ...
    <div className='demo'>
        <div className='container'>
            <div className='col-1'>
                ...
                <p>One Philosophy</p>
                <p>Every single one of our financial advisors receivers rigorous training 
                    according to John Doe's philosophy based on academic research (including 
                    that of a Nobel Laureate in Economics ) and Behavioral Finance.
                    ans </p>
